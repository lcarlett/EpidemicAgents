...
#grid = Grid(size = (50,100), cell_size = 10, base_infected = 100 , base_immune = 0, desease = Desease(1/18, 0.20), sec_between_frame = .2)

grid = Grid(size = (90, 90), number_agents = 2000, base_infected = 100 , base_immune = 1950, desease = Desease(1/18,0,15), startAnimate = True)    
